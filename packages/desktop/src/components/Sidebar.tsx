...
const toolSections = [
  {
    ...
    tools: [
      ...
      // { id: "ocr", label: "OCR PDF", icon: "🔍", kbd: "Ctrl+5" }, // Phase 2 - backend pending
    ],
  },
  {
    name: "Media",
  ...
  },
  {
    ...
    tools: [
      ...
      // { id: "watermark", label: "Watermark", icon: "💧", kbd: "Ctrl+8" }, // Phase 2 - backend pending
    ],
  },
  {
    name: "Batch",
    ...
    tools: [
      ...
      // { id: "batchfolder", label: "Batch folder", icon: "📁" }, // Phase 2 - backend pending
    ],
  },
  {
    name: "System",
