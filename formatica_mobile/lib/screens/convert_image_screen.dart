...
class _ConvertImageScreenState extends State<ConvertImageScreen> {
              ...
              if (_filePath != null) ...[
                ...
                if (_selectedFormat != null) ...[
                  ...
                  if (showQualitySlider) ...[
                    const Text('IMAGE QUALITY', style: AppTextStyles.sectionLabel),
                    const SizedBox(height: 12),
                    _qualitySlider(),
                  ] else ...[
                    const Text('Lossless for PNG, BMP, GIF', style: AppTextStyles.caption),
                  ],
                ],
              ],
        ...
        child: _filePath == null
            ? Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  const Text('Tap to select image', style: AppTextStyles.bodyText),
                  const SizedBox(height: 4),
                  Text('JPG · PNG · WEBP · BMP · GIF', style: AppTextStyles.caption.copyWith(color: Colors.grey)),
                ],
              )
            : Column(
                mainAxisAlignment: MainAxisAlignment.center,
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Text('${_quality.toInt()}%', style: AppTextStyles.fieldLabel.copyWith(color: AppColors.primaryIndigo)),
  ...
  Widget _buildSuccessCard() {
    return SuccessCard(
      ...
      label: 'Image converted successfully',
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: _isConverting
            ...
            : const Text('Convert Image', style: AppTextStyles.buttonLabel),
      ),
    );
  }
