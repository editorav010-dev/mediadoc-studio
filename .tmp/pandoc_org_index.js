...
function loadPandoc() {
  ...
  pandocReadyPromise = (async () => {
    ...
    const { convert, query } = await import("./pandoc.js?sha1=f6cdf331f70e810232d09ea7235c4f344c25db1f");
  ...
  return {
    ...
    async loadExample() {
      ...
      try {
        ...
        const response = await fetch(zipPath + "?sha1=7954ae651a3405013885baefe43804d9645ab401");
